...
<div id="app">
    <nav class="navbar navbar-expand-md navbar-light bg-light sticky-top container-fluid">
        <div class="container-fluid header">
            <a class="navbar-btn" href="{{ route('home') }}">
                <img class=" preload-me"
                     src="{{ asset('upload/image/logo.jfif') }}">
            </a>
            ...
            <div class="col-md-4 search">
                <form action="" method="get">
                    <input type="text" name="key" id="seacher" placeholder=" Tìm kiếm"
                ...
                @if(Auth::check())
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown"
                            ...
                            <div><a class="nav-link dropdown-item" href="taikhoan/{{Auth::user()->id}}">Account</a>
                            </div>
                            <div><a class="nav-link dropdown-item" href="{{ route('user.logout') }}">Logout</a></div>
                        </div>
                    </div>
                @else
                    <div class="nav-item">
...
<footer>
    ...
    <div class="col-12 rowfoot2">
        <div class="container-fluid">
            <p>© 2020 Công ty cổ phần . GPDKKD: 0303217354 do sở KH &amp; ĐT TP.HCM cấp ngày 02/01/2007. GP số
                57/GP-TTĐT do Sở TTTT TP HCM cấp ngày 30/07/2018.
                <br> Địa chỉ: 128 Trần Quang Khải, P. Tân Định, Quận 1, TP.Hồ Chí Minh. Điện thoại: (028)3812.59.60.
                Email: cskh@dienmayxanh.com. Chịu trách nhiệm nội dung: Trần Nhật Linh.
